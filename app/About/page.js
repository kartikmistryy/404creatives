    ...
    <div className='mt-24 w-full h-full bg-gray-100'>
        <main className='flex flex-col w-full h-full'>
          <div className='flex xl:flex-row flex-col justify-between items-center w-full h-full md:p-10 p-5 gap-10'>
            <div className='flex flex-col xl:w-[45%] w-full items-start justify-start'>
              <h1 className='md:text-8xl text-3xl font-semibold tracking-wider'>ABOUT US</h1>
              <p className='flex md:w-[70%] sm:w-[80%] w-full md:mt-10 mt-5'>From eye-catching visuals to powerful digital experiences, we blend artistry with technology to help businesses stand out in a crowded marketplace. Our expertise spans branding, web design, content creation, and digital marketing, ensuring that every project we take on leaves a lasting impact.</p>
            </div>
              ...
              <div className='w-full bg-white h-full p-4 rounded-xl flex sm:flex-row flex-col gap-5'>
                <div className='flex flex-row h-full min-h-[180px] lg:max-h-[200px] max-h-full basis-1/2 gap-4'>
                  <span className='w-full flex flex-col'>
                    <h1 className='lg:w-1/2 w-full text-base font-medium'>NEHA PATIL</h1>
                ...
                <div className='flex flex-row-reverse h-full min-h-[180px] lg:min-h-[200px] lg:max-h-[200px] max-h-full basis-1/2 gap-4'>
                  <span className='w-full flex flex-col'>
                    <h1 className='lg:w-1/2 w-full text-base font-medium'>KAUSHIK YAMBER</h1>
                    <hr className='border-gray-600 my-2 w-1/2'/>
          ...
          <div className='md:p-10 p-5'>
            <div className='xl:w-[60%] w-full bg-white h-full  rounded-xl flex sm:flex-row flex-col gap-5 xl:pl-20 p-4'>
                <div className='flex flex-row h-full min-h-[180px] lg:max-h-[200px] max-h-full basis-1/2 gap-4'>
                  <span className='w-full flex flex-col'>
                    <h1 className='lg:w-1/2 w-full text-base font-medium'>BABITA</h1>
                    <hr className='border-gray-600 my-2 w-1/2'/>
        ...
        <div className='w-full h-full md:p-10 p-5'>
          <div className='flex w-full flex-col items-start'>
            <h1 className='md:text-8xl text-3xl font-semibold tracking-wide'>CONTACT US</h1>
            <p className='flex lg:w-[60%]  w-full md:mt-10 my-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam similique ad nihil earum distinctio accusamus, suscipit voluptatem. Aspernatur, repellat quasi!</p>
          ...
          <form action="" className='mt-10 flex md:flex-row flex-col lg:w-[90%] w-full h-full lg:gap-20 gap-4'>
            <div className='flex flex-col w-full gap-4 md:pb-14 pb-0'>
              <span className='flex flex-col gap-2'>
                ...
                <input type="text" placeholder='Fransico Andrade' className='p-2 rounded-[4px] text-sm'/>
              </span>
              <div className='flex md:flex-row flex-col gap-4 w-full'>
                <span className='flex flex-col gap-2 w-full'>
                  <label htmlFor="name" className='text-lg'>Email</label>
                  <input type="email" placeholder='fransicoandrade@gmail.com' className='p-2 rounded-[4px] text-sm'/>
                </span>
                <span className='flex flex-col gap-2 w-full'>
                  <label htmlFor="phone" className='text-lg'>Phone Number</label>
                  <input type="number" placeholder='+123-456-7890' className='p-2 rounded-[4px] text-sm'/>
                </span>
              </div>
            </div>
            <div className='flex flex-col w-full gap-4'>
              <span className='flex flex-col gap-4 h-full'>
                ...
                <textarea name="" placeholder="Hi, we love the cats!" className='p-2 rounded-[4px] text-sm h-full flex' rows={6}></textarea>
              </span>
              <button className='w-fit px-6 py-2 bg-black text-white rounded-[4px] text-sm font-semibold'>
                SUBMIT
              </button>
            </div>
          </form>
