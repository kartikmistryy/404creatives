        ...
        >
          ...
          <div className="w-fit h-fit flex flex-col md:gap-8 gap-2">
            ...
            <span className="flex flex-col md:gap-4 gap-2">
              <Link
                target="_blank"
                className="font-medium text-gray-300 cursor-pointer"
                href="mailto:hello@404creative.co.in"
              >
                hello@404creative.co.in
              </Link>
              {/* <p>+91 98 33 26 7464</p> */}
              <Link 
              target="_blank"
              href="tel:+919594987676">+91 95 94 98 7676</Link>
            </span>
          </div>
          ...
          <div className="w-fit h-fit flex flex-col md:gap-8 gap-2">
            ...
            <span className="flex flex-row gap-6">
              ...
              <Link 
              target="_blank"
              href="https://www.linkedin.com/company/404-creatives/">
                <FaLinkedin className="text-2xl cursor-pointer" />
              </Link>
              <Link 
              target="_blank"
              href="https://www.threads.net/@404creative.co.in">
                <svg
              ...
              <Link 
              target="_blank" 
              href="https://in.pinterest.com/Neeehuh/">
