            ...
            <div className='w-full h-fit flex flex-col md:gap-8 gap-2'>
                ...
                <span className='flex flex-row gap-6'>
                    ...
                    <Link href='https://www.threads.net/@404creative.co.in'>
                        <svg className='text-2xl cursor-pointer mt-[1px]' xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <Link href='https://x.com/404creative_Co'>
                        <svg className='text-2xl cursor-pointer mt-[1px]' xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
