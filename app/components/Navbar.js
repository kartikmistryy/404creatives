          ...
          <div className='w-full h-fit'>
            <div className='w-full md:h-[10vh] h-16 md:px-10 px-5 flex items-center justify-start '>
                <div className='w-full md:h-[10vh] h-16 flex items-center justify-start'>
                  ...
                  <ul className={`${chivo.className} lg:flex hidden flex-row justify-between md:gap-32 gap-10 w-fit md:text-[1.4vw] text-xl font-medium ml-[10vw]  }`}>
                  ...
                  <span className='flex items-center justify-between w-fit md:gap-10 gap-0 ml-auto'>
                      <button 
                      className={`${chivo.className} font-mono md:flex hidden items-center justify-center md:py-[3px] py-[5px] px-[25px] rounded-3xl border-2 border-[#252222] font-medium md:text-[1.4vw] text-lg md:scale-100 scale-75 `}>Shop</button>
                      <button 
                      onClick={() => {
                        setShowMenu((prev) => !prev)
                      }}
            ...
            <div>
              <ul className={`${chivo.className} lg:hidden flex flex-row justify-center gap-8 w-[100vw] text-[0.7rem] font-medium mx-auto px-8  }`}>
                        <li><a  href="#">Graphic Design</a></li>
                        <li><a href="/Illustrations">Illustration</a></li>
