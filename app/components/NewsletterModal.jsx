...
const NewsletterModal = () => {
  ...
  return (
    <div
      ...
      className="w-screen h-screen z-[222] bg-transparent flex justify-center items-center fixed p-5"
    >
      <motion.div
        initial={{ translateY: 50 }}
        animate={{ translateY: 0 }}
        transition={{ type: "tween", stiffness: 200, damping: 100 }}
      ...
      >
        <span className="p-3 w-full h-10 flex items-start justify-end border-b-2 border-black">
          <GrClose onClick={() => setShowModal(false)} className="cursor-pointer" />
        </span>
        ...
        <p className="px-4 pb-1 text-lg">
          Join the 404Club crew today - we've got tons of creative perks waiting for you!
        </p>
