...
const NirmalaCreation = () => {
  ...
  return (
    <div className='mt-24 md:mt-[10vh] md:px-10 px-5'>
        ...
        <main>
            <Image priority src='/Branding/bakencake/1.png' width={1000} height={1000} alt='nirmala' className='w-full h-auto'/>
            <Image priority src='/Branding/bakencake/2.png' width={1000} height={1000} alt='nirmala' className='w-full h-auto'/>
            <video src='/Branding/bakencake/3.mp4' playsInline autoPlay loop muted controls={false} className='w-full h-auto'></video>          
            <Image priority src='/Branding/bakencake/4.png' width={1000} height={1000} alt='nirmala' className='w-full h-auto'/>
            <Image priority src='/Branding/bakencake/5.png' width={1000} height={1000} alt='nirmala' className='w-full h-auto'/>
        </main>
    </div>
  )
}
