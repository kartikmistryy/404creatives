        ...
        <div className='w-full md:h-[80vh] h-full flex md:flex-row-reverse flex-col items-start'>
            <div className='w-full h-full flex flex-col justify-between items-start  border-t-[1px] border-black'>
                <main className='flex flex-col md:px-10 px-5 gap-2 h-full w-full items-start border-b-[1px] border-black py-10 justify-center min-h-[350px]'>
                    <h1 className='md:text-[5vw] text-[3.2rem] leading-[100%] md font-medium'>TRUST CONSULT GROUP</h1>
        ...
        <div className='w-full md:h-[80vh] h-full flex md:flex-row flex-col items-start border-t-[1px] border-black'>
            <div className='w-full h-[80vh] flex flex-col items-start'>
                <main className='flex flex-col md:px-10 px-5 py-10 md:py-0 w-full items-start justify-center md:h-[40vh] h-full gap-4 border-b-[1px] border-black'>
                    ...
                    <h4 className='md:text-2xl text-xl md:w-2/3 w-full font-medium'>BRANDING + MARKETING + STATIONARY</h4>
                </main>
               <span className='md:px-10 px-5 py-10 md:py-0 w-full md:h-[40vh] h-full flex flex-col items-start justify-center md:gap-6 gap-2'>
                    <h3 className='text-2xl font-medium'>OVERVIEW</h3>
