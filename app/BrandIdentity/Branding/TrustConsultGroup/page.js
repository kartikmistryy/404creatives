      ...
      <div className="w-full h-full max-w-[1600px] mx-auto md:px-10 px-5">
        <div className="flex flex-row items-center w-full justify-start gap-4 my-4 py-2">
          <span className="w-fit">
            <Image
              src="/Branding/trustconsultgroup/logo.png"
              width={500}
              height={500}
              alt="trustconsultgroup_logo"
        ...
        <main>
          <Image
            ...
            layout="intrinsic"
            priority
            src="/Branding/trustconsultgroup/01.png"
            width={4000}
            height={4000}
            alt="nirmala"
          ...
          />
          <video
            src="/Branding/trustconsultgroup/03.mp4"
            playsInline
            autoPlay
            loop
            muted
          ...
          <Image
            ...
            layout="intrinsic"
            priority
            src="/Branding/trustconsultgroup/02.png"
            width={4000}
            height={4000}
            alt="nirmala"
            className="w-full h-auto"
          ...
          <Image
            ...
            layout="intrinsic"
            priority
            src="/Branding/trustconsultgroup/04.png"
            width={4000}
            height={4000}
            alt="nirmala"
            className="w-full h-auto"
          ...
          <Image
            ...
            layout="intrinsic"
            priority
            src="/Branding/trustconsultgroup/05.png"
            width={4000}
            height={4000}
            alt="nirmala"
            className="w-full h-auto"
