...
const Shop = () => {
  return (
    <div className={`${chivo.className} flex flex-col items-start justify-start h-full md:mt-[10vh] mt-16 w-full md:px-10 px-5 max-w-[100vw]`}>
        <h1 className='my-20 md:text-8xl text-6xl font-sans font-light text-[#252222]'>COMING <br /> SOON</h1>

        <main className='w-full max-w-[100vw]  grid grid-cols-2 lg:grid-cols-4 justify-between items-center my-10 gap-20 font-sans'>
            <span className='flex flex-col items-start justify-center md:w-1/4 w-full h-full'>
            <Image width={300} height={300} className='w-[100px] h-[100px] md:h-[120px] md:w-[120px] my-5' alt='image' src='./globe.svg'  />
