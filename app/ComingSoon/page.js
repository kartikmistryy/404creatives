...
const ComingSoon = () => {
  return (
    <div className={`${chivo.className} w-full h-screen min-h-screen bg-[url(/comingSoon.gif)] bg-cover bg-center pt-[10vh] lg:pl-10 p-5 relative`}>
        <div className='flex lg:flex-row flex-col justify-between w-full max-w-[1600px] h-full mx-auto'>
            ...
            <Image src="/Logo/404.png" width={1000} height={1000} alt='404Logo' className='w-[250px] h-[250px] mt-auto ml-auto'/>
        </div>
    </div>
  )
}
